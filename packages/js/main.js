...
// Set the default theme to dark if no selection is stored
if (!selectedTheme) {
  enableDarkTheme();
} else {
  // If the user previously chose a theme, apply the stored selection
...
themeButton.addEventListener("click", () => {
  ...
  // Update the selected theme and icon in localStorage
